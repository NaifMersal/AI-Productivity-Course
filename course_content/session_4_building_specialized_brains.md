# Session 4: Building "Specialized Brains" (Global Context) (13:30 – 15:00)
...
In Session 3, we wrote a perfect R-C-T-C prompt to update **Dr. Ahmad** about the Hydrogen Report. It worked great.
...
Recall our **Project Lead** scenario from Session 3. We are going to turn that "one-off" prompt into a permanent tool.
