...
3.  **Instruction (Using R-C-T-C from Session 2):** "Based *only* on the uploaded report, summarize the visitor adoption rates for the Red Sea destinations vs. AlUla."
